...
namespace chatdylan
{
    ...
    sealed partial class App : Application
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient(
            "https://chatdylan.azurewebsites.net"
        );

        //propiedades añadidas (signal R) 
        ...
        public void SignalR()
        {
            //conn = new HubConnection("http://chatdylan.azurewebsites.net");
            //conn = new HubConnection("http://chatnervion.azurewebsites.net");
            conn = new HubConnection("http://chatdeclase.azurewebsites.net");
